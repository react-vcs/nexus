...
const Slider = (props) => {
  // Default data to an empty array if undefined to prevent errors
  ...
  return (
    ...
    >
      {data.map((item, index) => (
        <div className="px-2 pt-16 pb-8 w-full flex justify-center" key={index}>
          <div className="bg-white lg:mx-3 lg:flex lg:max-w-5xl lg:shadow-lg rounded-lg">
            ...
            <div className="pt-6 px-2 max-w-xl lg:max-w-5xl lg:w-1/2 rounded-t-none border lg:rounded-lg">
              <h2 className="text-xl text-gray-800 font-bold">{item?.title}</h2>
